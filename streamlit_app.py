...
# ---------------------
TMDB_API_KEY = "6740125ed80fde295270a1f93cf0105a"
...
background_image = "dataset/pngtree-empty-cinema-screen-in-3d-rendering-image_3722785.jpg"  # ganti sesuai path gambar
st.markdown(
    f"""
    <style>
    .stApp {{
